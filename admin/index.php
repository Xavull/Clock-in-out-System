...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> |Online  Employee Attendance System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'employees')? 'active' : '' ?>" href="./?page=employees"><i class="fa fa-user-friends"></i> Employees</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'attendance_list')? 'active' : '' ?>" href="./?page=attendance_list"><i class="fa fa-th-list"></i> Attendance</a>
                    </li>
